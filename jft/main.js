...
// main.js - Entry Point (Penyatu)

// PERUBAHAN: Tambahkan './js/' di depan nama file
import { state } from './js/state.js';
import { loadSystemVoices } from './js/audio.js';
...
// --- BINDING GLOBAL FUNCTION (PENTING!) ---
// Agar onclick="..." di HTML bisa membaca fungsi ini
...
function initExamPage() {
    ...
    renderSectionNav(renderQuestion); // Pass render function
